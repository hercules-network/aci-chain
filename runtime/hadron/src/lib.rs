...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("aci"),
    impl_name: create_runtime_str!("aci"),
    authoring_version: 1,
    spec_version: 46,
    impl_version: 1,
...
parameter_types! {
    ...
    pub const AciDeacModuleId: ModuleId = ModuleId(*b"aci/deac");
    pub const AciBlindBoxModuleId: ModuleId = ModuleId(*b"aci/bbxb");
    pub const LotteryModuleId: ModuleId = ModuleId(*b"aci/lotb");
    pub const SocietyModuleId: ModuleId = ModuleId(*b"aci/soci");
    pub const ElectionsPhragmenModuleId: LockIdentifier = *b"aci/phre";
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        // Aci: pallet_balances::<Instance0>::{Module, Call, Storage, Config<T>, Event<T>},
        ...
        Deac: pallet_multi::{Module, Call, Storage, Event<T>} = 63,
        BlindBox: pallet_blindbox::{Module, Call, Storage, Event<T>} = 64,
...
impl ap_rpc::ConvertTransaction<UncheckedExtrinsic> for TransactionConverter {
...
impl ap_rpc::ConvertTransaction<opaque::UncheckedExtrinsic> for TransactionConverter {
...
impl_runtime_apis! {
    ...
    impl ap_rpc::EthereumRuntimeRPCApi<Block> for Runtime {
        fn chain_id() -> u64 {
