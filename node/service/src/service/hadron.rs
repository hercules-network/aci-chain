...
use aci_rpc::hadron::FullDeps;
pub use aci_hadron_runtime;
...
use ac_consensus::FrontierBlockImport;
use ac_rpc_core::types::{FilterPool, PendingTransactions};
use aci_hadron_runtime::opaque::Block;
use sc_telemetry::TelemetrySpan;

// Our native executor instance.
native_executor_instance!(
    pub HadronExecutor,
    aci_hadron_runtime::api::dispatch,
    aci_hadron_runtime::native_version,
        ...
        RuntimeEvmApiCollection<StateBackend = StateBackendFor<FullBackend, Block>>,
{
    ...
    let rpc_extensions_builder = {
        ...
        Box::new(move |deny_unsafe, _| {
            ...
            aci_rpc::hadron::create_full(deps, subscription_task_executor.clone())
        })
    };
        ...
        RuntimeEvmApiCollection<StateBackend = StateBackendFor<LightBackend, Block>>,
{
    ...
    let light_deps = aci_rpc::hadron::LightDeps {
    ...
    let rpc_extensions = aci_rpc::hadron::create_light(light_deps);
...
pub fn hadron_new_full(
    ...
    (
        TaskManager,
        Arc<impl AciClient<Block, FullBackend, aci_hadron_runtime::RuntimeApi>>,
    ),
    ServiceError,
> {
    let (components, client) =
        new_full::<aci_hadron_runtime::RuntimeApi, HadronExecutor>(config, false)?;
...
pub fn hadron_new_light(config: Configuration) -> Result<TaskManager, ServiceError> {
    new_light::<aci_hadron_runtime::RuntimeApi, HadronExecutor>(config)
}