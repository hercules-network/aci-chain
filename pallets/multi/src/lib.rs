...
use aci_primitives::{CurrencyId, Balance as CurrencyBalance};
...
decl_module! {
    pub struct Module<T: Config> for enum Call where origin: T::Origin {
        ...
        pub fn accept_sale_order(origin, collection_id: u64, item_id: u64) -> DispatchResult {
            ...
            <T as Config>::MultiCurrency::transfer(currency_id, &sender, &deac_owner, price.saturated_into())?;
        ...
        pub fn accept_separable_sale_order(origin, order_id: u64, value: u64) -> DispatchResult {
            ...
            <T as Config>::MultiCurrency::transfer(currency_id, &sender, &deac_owner, checked_value.into())?;
